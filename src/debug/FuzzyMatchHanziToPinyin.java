 ...
 *
 */
public class FuzzyMatchHanziToPinyin {
    ...
    private static FuzzyMatchHanziToPinyin sInstance;
    ...
    protected FuzzyMatchHanziToPinyin(boolean hasChinaCollator) {
        mHasChinaCollator = hasChinaCollator;
    }

    public static FuzzyMatchHanziToPinyin getInstance() {
        synchronized (FuzzyMatchHanziToPinyin.class) {
            if (sInstance != null) {
                return sInstance;
            }
            ...
            for (int i = 0; i < locale.length; i++) {
                if (locale[i].equals(Locale.CHINA)) {
                    ...
                    sInstance = new FuzzyMatchHanziToPinyin(true);
                    return sInstance;
                }
            }
            sInstance = new FuzzyMatchHanziToPinyin(false);
            return sInstance;
        }
    }
    ...
    public ArrayList<Token> get(final String input) {
        ...
        if (!mHasChinaCollator || isEmpty(input)) {
            // return empty tokens.
            return tokens;
        }
     ...
     * collator, the empty token array is returned.
     */
    public ArrayList<Token> getT(final String input) {
        ArrayList<Token> tokens = new ArrayList<Token>();
        if (isEmpty(input)) {
            // return empty tokens.
            return tokens;
